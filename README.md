...
![](./readme-assets/multi-module.png)
...
On the [second branch](https://github.com/eryigithan16/DearDiary/tree/multi_module) the project is restructured into a Multi-Module Architecture using layered features.
...
|------------------------------------|--------------------------------|--------------------------------|
| ![](./readme-assets/gif_1.gif) | ![](./readme-assets/gif_2.gif) | ![](./readme-assets/gif_3.gif) |
